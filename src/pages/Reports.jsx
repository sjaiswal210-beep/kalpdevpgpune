...
export default function Reports() {
  ...
  const reportCards = [
    ...
    { label: 'Total Expenses', value: formatCurrency(totalExpenses), icon: TrendingDown, color: 'text-pink-500', bg: 'bg-pink-50 dark:bg-pink-900/20' },
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={monthlyData}>
                ...
                <Bar dataKey="collected" fill="#F472B6" radius={[6, 6, 0, 0]} name="Collected" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </motion.div>
