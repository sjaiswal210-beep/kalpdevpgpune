...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen font-poppins bg-white">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div><div className="font-medium">Phone</div><div className="text-sm text-gray-300">+91 73507 85606</div></div>
              </div>
              <div className="flex items-center gap-4">
      ...
      <a href="https://wa.me/917350785606" target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 hover:scale-110 transition-all z-50" aria-label="WhatsApp">
