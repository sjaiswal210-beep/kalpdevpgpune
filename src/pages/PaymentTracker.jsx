  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <StatCard icon={CreditCard} label="Total Due" value={formatCurrency(paymentStatus.length * RENT_PER_PERSON)} color="bg-pink-50 dark:bg-pink-900/20 text-pink-500" />
      ...
      {showAutoReminder && (
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-pink-600 dark:text-pink-400">It's the 2nd! Time to send rent reminders</p>
              <p className="text-sm text-pink-500 dark:text-pink-400">{unpaid.length} tenant(s) haven't paid yet for {monthLabel}</p>
            </div>
          </div>
          <div className="flex gap-2">
            <button onClick={sendBulkReminders} className="px-4 py-2 bg-pink-400 text-white rounded-xl text-sm font-medium hover:bg-purple-700 transition flex items-center gap-2">
