...
export default function StudentRewards() {
  ...
  return (
    <div className="space-y-6">
      {/* Points Card */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-gradient-to-r from-pink-400 to-rose-400 rounded-2xl p-6 text-white relative overflow-hidden">
      ...
      <div>
        <h3 className="font-semibold text-gray-900 dark:text-white flex items-center gap-2 mb-4">
          <ShoppingBag className="w-5 h-5 text-pink-500" /> Shop & Earn Points
        </h3>
        ...
        <div className="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 border border-orange-200 dark:border-orange-800 rounded-2xl p-5 mb-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="px-2 py-0.5 bg-pink-100 dark:bg-pink-900/30 text-pink-600 dark:text-pink-400 rounded-full text-xs font-bold">Cashback</span>
          </div>
              ...
              <motion.div key={p.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="glass-card-solid overflow-hidden">
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="px-2 py-0.5 bg-pink-100 dark:bg-pink-900/30 text-pink-600 dark:text-pink-400 rounded-full text-xs font-bold flex items-center gap-1">
                  ...
                  <button onClick={() => setShowClaim(p)} className="w-full py-2.5 bg-gradient-to-r from-pink-400 to-rose-400 text-white rounded-xl text-sm font-semibold hover:from-purple-700 hover:to-indigo-700 transition">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setShowClaim(null)}>
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} onClick={e => e.stopPropagation()} className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-sm shadow-2xl">
              ...
              <form onSubmit={handleClaim} className="p-6 space-y-4">
                ...
                <p className="text-xs text-pink-500 font-medium">You'll earn cashback points after admin verification</p>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} onClick={e => e.stopPropagation()} className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-sm shadow-2xl">
              ...
              <form onSubmit={handleRedeem} className="p-6 space-y-4">
                <div className="p-4 bg-pink-50 dark:bg-pink-900/20 rounded-xl text-center">
                  <div className="text-2xl font-bold text-pink-600 dark:text-pink-400">{points.balance} pts</div>
                  <div className="text-sm text-pink-500">Max discount: ₹{maxDiscount}</div>
                </div>
                <div>
