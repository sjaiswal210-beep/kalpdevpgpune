        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-card">
          ...
          <div className="flex items-center gap-6">
            <div className="relative">
              ...
              <label className="absolute -bottom-2 -right-2 w-8 h-8 bg-pink-400 rounded-full flex items-center justify-center cursor-pointer hover:bg-purple-700 transition shadow-lg">
