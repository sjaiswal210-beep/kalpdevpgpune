...
import {
  ...
  UserCheck, BarChart3, Bell, Settings, LogOut, Building2, X, Globe, AlertCircle, Share2, Gift, Wallet, History, Send
} from 'lucide-react';
...
const navItems = [
  ...
  { path: '/admin/bulk-reminders', icon: Send, label: 'Bulk Reminders' },
